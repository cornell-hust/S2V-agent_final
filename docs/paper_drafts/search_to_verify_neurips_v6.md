# Search-to-Verify: Agentic Video Anomaly Understanding via Evidence-Faithful Reinforcement Learning
...
We organize evaluation into **primary metrics** that directly test our three claims, and **secondary metrics** that provide diagnostic detail (reported in the supplementary).

**Primary metrics (5):**
- **Category Macro-F1** — decision quality (Claim 1)
- **Event-Chain F1** — event-chain recovery quality (Claim 1)
- **Evidence F1@3** — evidence selection quality (Claim 2)
- **FECV Decision Sufficiency** — evidence faithfulness under counterfactual verification (Claim 3)
- **Verify-Finalize Followthrough** — protocol compliance rate (Claim 2)

**Secondary metrics** (temporal mIoU, precursor mIoU, evidence precision/recall, protocol compliance rate, mean turns, stage coverage, etc.) provide additional diagnostic information and are reported in full in the supplementary material.
