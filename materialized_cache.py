...
MATERIALIZED_CACHE_METADATA_SCHEMA_VERSION = 5
MATERIALIZED_SFT_MESSAGES_FORMAT = "materialized_sft_messages_v4"
MATERIALIZED_RUNTIME_ITEMS_FORMAT = "materialized_runtime_items_v4"
