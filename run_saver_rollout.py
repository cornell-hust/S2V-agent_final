...
def parse_args(argv: List[str] | None = None) -> argparse.Namespace:
    ...
    parser.add_argument("--max-turns", type=int, default=DEFAULT_ROLLOUT_MAX_TURNS, help="Maximum rollout turns.")
    parser.add_argument(
        "--policy-backend",
        choices=["replay", "qwen"],
        default="replay",
    ...
    parser.add_argument("--num-preview-frames", type=int, default=8, help="Legacy preview frame count. Used only when --initial-observation-mode=preview.")
    parser.add_argument("--preview-sampling-fps", type=float, default=None, help="Legacy preview sampling fps. Used only when --initial-observation-mode=preview.")
